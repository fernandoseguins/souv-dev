document.addEventListener("DOMContentLoaded", function () {
  const agendeVisitaButton = document.getElementById("agende-visita");
...
document.addEventListener("DOMContentLoaded", function () {
    const entrarContatoButton = document.getElementById("entrar-contato");
...
function handleScrollPage() {
  const elements = document.querySelectorAll<HTMLElement>(".fade-in"); // Seleciona todos os elementos com a classe 'fade-in'
